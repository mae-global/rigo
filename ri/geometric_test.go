...
func Test_Geometric(t *testing.T) {
	...
	Convey("All Geometric", t, func() {
		...
		So(ctx.PointsPolygons(2, RtIntArray{3, 3, 3}, RtIntArray{0, 3, 2, 0, 1, 3, 1, 4, 3}, RtToken("P"), RtPointArray(points)), ErrorShouldEqual, `PointsPolygons [3 3 3] [0 3 2 0 1 3 1 4 3] "P" [0 1 0 0 1 1 0 0 1 0 0 0]`)
		...
		So(ctx.PointsGeneralPolygons(2, RtIntArray{2, 2}, RtIntArray{4, 3, 4, 3}, RtIntArray{0, 1, 4, 3, 6, 7, 8, 1, 2, 5, 4, 9, 10, 11},
			RtToken("P"), RtPointArray(points)), ErrorShouldEqual, `PointsGeneralPolygons [2 2] [4 3 4 3] [0 1 4 3 6 7 8 1 2 5 4 9 10 11] "P" [0 1 0 0 1 1 0 0 1 0 0 0]`)
