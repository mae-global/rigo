...
func Test_Patches(t *testing.T) {
	...
	Convey("All Patches", t, func() {
		...
		So(ctx.PatchMesh(BICUBIC, 7, "nonperiodic", 4, "nonperiodic", RtToken("point[4] P"), RtPointArray(points)), ErrorShouldEqual, `PatchMesh "bicubic" 7 "nonperiodic" 4 "nonperiodic" "point[4] P" [0 1 0 0 1 1 0 0 1 0 0 0]`)
